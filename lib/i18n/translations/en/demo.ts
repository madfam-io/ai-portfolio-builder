...
export default {
  ...
  demoVideoComingSoon: 'Video Demo Coming Soon',
  demoVideoComingSoonDesc: 'Meanwhile, try our interactive demo',
  ...
  demoStep2Desc: 'Our AI analyzes and enhances your content for maximum impact',
  demoStep2Duration: '2 minutes',
  demoStep3Title: 'Choose Template',
  demoStep3Desc: 'Select from professional templates tailored to your industry',
