...
/**
 * @fileoverview Template component English translations
 * @module i18n/translations/en/templates
 */
...
export default {
  ...
  designerTemplateDesc:
    'Creative design with visual portfolio gallery and social metrics',
  consultantTemplateDesc:
    'Professional business-focused approach with metrics and case studies',
} as const;
