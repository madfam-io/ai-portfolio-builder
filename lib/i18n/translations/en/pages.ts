...
/**
 * @fileoverview Page-specific English translations
 * @module i18n/translations/en/pages
 */
...
export default {
  ...
  accessibilityText:
    'Professional portfolio creation should be available to everyone, regardless of technical skills.',
  ...
  apiDocsTitle: 'Comprehensive Documentation',
  apiDocsDesc:
  ...
  apiHrDesc:
    'Generate portfolios for job candidates automatically from resume data.',
  ...
  blogPost3Title:
    'From LinkedIn to Portfolio: Converting Connections into Clients',
  blogPost3Excerpt:
  ...
  careersBenefitsDesc: 'Medical, dental, vision plus mental health support.',
  ...
  careersInclusiveDesc:
    "Diverse and collaborative environment where everyone's voice matters.",
  ...
  careersPosition1Req1: '5+ years of React/Node.js experience',
  ...
  careersPosition3Description:
    'Research and develop AI models for content generation, template recommendation, and portfolio optimization using the latest ML techniques.',
  ...
  gdprExerciseDesc:
    "To exercise any of your GDPR rights, please contact us. We'll respond within 30 days and may require identity verification.",
