...
/**
 * @fileoverview Editor English translations
 * @module i18n/translations/en/editor
 */
...
export default {
  ...
  back: 'Back',
  templateDescription: 'Select a design that matches your style and industry',
  importYourData: 'Import your data',
  importDescription: 'Speed up the process by importing from existing profiles',
  importFromLinkedIn: 'Import your professional experience',
  importFromGitHub: 'Import your projects and contributions',
  uploadCV: 'Upload CV',
  uploadCVDescription: 'Upload your resume (PDF/DOC)',
  ...
  creativeDesc: 'Bold and artistic design',
  ...
  importProfessionalInfo: 'Import your professional information',
  ...
  // Error messages
  aiEnhancementRequiresAuth: 'You must be signed in to use AI enhancement',
  aiQuotaExceeded: 'You have reached the AI enhancement limit',
