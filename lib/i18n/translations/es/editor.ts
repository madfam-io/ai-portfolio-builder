...
/**
 * @fileoverview Editor Spanish translations
 * @module i18n/translations/es/editor
 */
...
export default {
  ...
  portfolioNamePlaceholder: 'Mi Portafolio Profesional',
  ...
  importFromGitHub: 'Importa tus proyectos y contribuciones',
  uploadCV: 'Subir CV',
  ...
  noPortfolioSelected: 'No hay portafolio seleccionado',
  undo: 'Deshacer',
  redo: 'Rehacer',
  togglePreview: 'Alternar Vista Previa',
  hidePreview: 'Ocultar Vista Previa',
  showPreview: 'Mostrar Vista Previa',
  portfolioSaved: 'Portafolio guardado exitosamente',
  failedToSave: 'Error al guardar el portafolio',
  changesSaved: 'Tus cambios han sido guardados',
  editingPortfolio: 'Editando',
  heroSection: 'Sección Principal',
  headline: 'Titular',
  enterHeadline: 'Ingresa tu titular',
  tagline: 'Eslogan',
  enterTagline: 'Un eslogan corto y memorable',
  ...
  // Error messages
  aiEnhancementRequiresAuth: 'Debes iniciar sesión para usar la mejora con IA',
  ...
  date: 'Fecha',
  formImplementation: 'Implementación de formulario para',

  // Device preview
  devicePreview: 'Vista Previa de Dispositivo',
  desktop: 'Escritorio',
  tablet: 'Tableta',
  mobile: 'Móvil',
  showDeviceFrame: 'Mostrar Marco del Dispositivo',
  hideDeviceFrame: 'Ocultar Marco del Dispositivo',
  ...
  // Settings
  portfolioSettings: 'Configuración del Portafolio',
  ...
  tabletSize: '768 × 1024',
  mobileSize: '375 × 812',
  portfolioPreviewTitle: 'Vista Previa del Portafolio',
} as const;
