...
const translations = {
  ...
  es: {
    ...
    // Blog Page - Missing Keys
    blogPost1Title: '10 Tendencias de Diseño de Portafolio que Dominarán 2024',
    blogPost1Excerpt: 'Descubre las últimas tendencias de diseño que harán que tu portafolio destaque de la competencia y atraiga más oportunidades.',
    blogPost1Author: 'Equipo de Diseño MADFAM',
    blogPost1ReadTime: '5 min de lectura',
    blogPost2Title: 'Cómo la IA está Revolucionando los Portafolios Profesionales',
    blogPost2Excerpt: 'Aprende cómo la inteligencia artificial está transformando la forma en que los profesionales crean, optimizan y gestionan sus portafolios en línea.',
    blogPost2Author: 'Dra. Sarah Johnson',
    blogPost2ReadTime: '7 min de lectura',
    blogPost3Title: 'De LinkedIn a Portafolio: Convirtiendo Conexiones en Clientes',
    blogPost3Excerpt: 'Domina el arte de convertir tu red de LinkedIn en un poderoso motor de adquisición de clientes usando tu portafolio profesional.',
    blogPost3Author: 'Marcus Rodriguez',
    blogPost3ReadTime: '6 min de lectura',

    // Careers Page - Missing Keys
    careersOpenPositions: 'Posiciones Abiertas',
    careersApplyNow: 'Aplicar Ahora',
    careersKeyRequirements: 'Requisitos Clave:',
    careersNoMatchTitle: '¿No ves una coincidencia perfecta?',
    careersNoMatchDesc: 'Siempre estamos buscando personas talentosas que compartan nuestra pasión por la innovación y la excelencia.',
    careersSendResume: 'Envíanos tu CV',
    ...
    careersPosition1Description: 'Únete a nuestro equipo de ingeniería para construir la próxima generación de herramientas de portafolio impulsadas por IA. Trabaja con React, Node.js y tecnologías de IA de vanguardia.',
    ...
    careersPosition2Description: 'Dale forma a la experiencia de usuario de PRISMA y ayuda a millones de profesionales a crear portafolios impresionantes. Diseña para plataformas web y móviles.',
    ...
    careersPosition3Description: 'Investiga y desarrolla modelos de IA para generación de contenido, recomendación de plantillas y optimización de portafolios usando las últimas técnicas de ML.',
    ...
    careersPosition4Description: 'Impulsa la adopción y el éxito del cliente, asegurando que nuestros usuarios obtengan el máximo valor de PRISMA. Trabaja estrechamente con los equipos de producto e ingeniería.',
    ...
    // Privacy Page - Additional Missing Keys
    privacyTitle: 'Política de Privacidad',
    privacyLastUpdated: 'Última actualización: Enero 2024',
    privacyInfoCollectTitle: 'Información que Recopilamos',
    privacyInfoCollectText: 'Recopilamos información que nos proporcionas directamente y datos sobre cómo usas nuestros servicios.',
    privacyInfoCollectItem1: 'Información de cuenta (nombre, correo electrónico, contraseña)',
    privacyInfoCollectItem2: 'Contenido del portafolio (proyectos, biografía, imágenes)',
    privacyInfoCollectItem3: 'Datos de uso (páginas visitadas, funciones utilizadas)',
    privacyInfoCollectItem4: 'Información técnica (dirección IP, tipo de navegador)',
    privacyHowUseTitle: 'Cómo Usamos tu Información',
    privacyHowUseText: 'Utilizamos la información recopilada para proporcionar, mantener y mejorar nuestros servicios.',
    ...
    privacyDataProtectionText: 'Implementamos medidas de seguridad técnicas y organizativas para proteger tu información personal contra el acceso no autorizado, la alteración, divulgación o destrucción.',
    privacyYourRightsTitle: 'Tus Derechos',
    privacyYourRightsText: 'Tienes derecho a acceder, actualizar, eliminar o exportar tu información personal.',
    ...
    privacyCookiesText: 'Utilizamos cookies para mejorar tu experiencia, analizar el tráfico del sitio y personalizar el contenido. Puedes controlar las cookies a través de la configuración de tu navegador.',
    privacyChangesTitle: 'Cambios a esta Política',
    privacyChangesText: 'Podemos actualizar esta política de privacidad periódicamente. Te notificaremos sobre cambios significativos publicando la nueva política en esta página.',
    privacyContactTitle: 'Contáctanos',
    privacyContactText: 'Si tienes preguntas sobre esta política de privacidad, por favor contáctanos en:',
    privacyContactAddress: 'Ciudad de México, México',

    // Terms Page - Additional Missing Keys
    termsAcceptanceTitle: 'Aceptación de los Términos',
    termsAcceptanceText: 'Al acceder y usar PRISMA, aceptas estar sujeto a estos Términos de Servicio y todas las leyes y regulaciones aplicables.',
    termsUseLicenseTitle: 'Licencia de Uso',
    termsUseLicenseText: 'Se te otorga una licencia limitada, no exclusiva y no transferible para usar PRISMA para crear y gestionar tu portafolio profesional.',
    termsUseLicenseItem1: 'Crear y publicar tu portafolio personal',
    termsUseLicenseItem2: 'Usar las herramientas de IA para mejorar tu contenido',
    termsUseLicenseItem3: 'Compartir tu portafolio con otros',
    termsUseLicenseItem4: 'Acceder a plantillas y recursos disponibles',
    termsAccountTitle: 'Tu Cuenta',
    termsAccountText: 'Eres responsable de mantener la confidencialidad de tu cuenta y contraseña. Aceptas la responsabilidad de todas las actividades que ocurran bajo tu cuenta.',
    termsContentTitle: 'Tu Contenido',
    termsContentText: 'Retienes todos los derechos sobre el contenido que subes a PRISMA. Al subir contenido, nos otorgas una licencia para usarlo con el fin de proporcionar nuestros servicios.',
    termsProhibitedTitle: 'Usos Prohibidos',
    termsProhibitedText: 'No puedes usar PRISMA para:',
    termsProhibitedItem1: 'Violar leyes o regulaciones',
    termsProhibitedItem2: 'Infringir derechos de propiedad intelectual',
    termsProhibitedItem3: 'Distribuir malware o contenido dañino',
    termsProhibitedItem4: 'Acosar o dañar a otros usuarios',
    termsProhibitedItem5: 'Intentar acceder sin autorización a nuestros sistemas',
    termsPaymentTitle: 'Pago y Facturación',
    termsPaymentText: 'Los planes de pago se facturan mensual o anualmente. Los pagos no son reembolsables excepto cuando lo requiera la ley.',
    termsTerminationTitle: 'Terminación',
    termsTerminationText: 'Podemos terminar o suspender tu cuenta inmediatamente, sin previo aviso, por cualquier violación de estos Términos.',
    termsDisclaimerTitle: 'Descargo de Responsabilidad',
    termsDisclaimerText: 'PRISMA se proporciona "tal cual" sin garantías de ningún tipo. No garantizamos que el servicio será ininterrumpido o libre de errores.',
    termsChangesTitle: 'Cambios a los Términos',
    termsChangesText: 'Nos reservamos el derecho de modificar estos términos en cualquier momento. Los cambios entran en vigor inmediatamente después de su publicación.',
    termsContactTitle: 'Información de Contacto',
    termsContactText: 'Para preguntas sobre estos Términos de Servicio, contáctanos en:',
    termsContactAddress: 'Ciudad de México, México',

    // GDPR Page - Additional Missing Keys
    gdprWhatDataTitle: 'Qué Datos Recopilamos',
    gdprAccountInfoTitle: 'Información de Cuenta',
    gdprAccountInfoDesc: 'Nombre, dirección de correo electrónico, contraseña (encriptada) e información de perfil que proporcionas.',
    gdprPortfolioDataTitle: 'Datos del Portafolio',
    gdprPortfolioDataDesc: 'Contenido que creas, subes o generas usando nuestra plataforma, incluyendo texto, imágenes e información de proyectos.',
    gdprUsageAnalyticsTitle: 'Análisis de Uso',
    gdprUsageAnalyticsDesc: 'Datos agregados y anónimos sobre cómo usas nuestra plataforma para mejorar nuestros servicios.',
    gdprTechnicalDataTitle: 'Datos Técnicos',
    gdprTechnicalDataDesc: 'Dirección IP, tipo de navegador, información del dispositivo y cookies para seguridad y funcionalidad.',
    gdprLegalBasisTitle: 'Base Legal para el Procesamiento',
    gdprContractTitle: 'Ejecución del Contrato',
    gdprContractDesc: 'Procesamiento necesario para proporcionar nuestros servicios de creación de portafolios según lo establecido en nuestros Términos de Servicio.',
    gdprLegitimateTitle: 'Interés Legítimo',
    gdprLegitimateDesc: 'Mejorar nuestros servicios, medidas de seguridad y proporcionar soporte al cliente.',
    gdprConsentTitle: 'Consentimiento',
    gdprConsentDesc: 'Comunicaciones de marketing, análisis opcionales e integraciones de terceros que apruebas explícitamente.',
    gdprExerciseTitle: 'Ejercer tus Derechos',
    gdprExerciseDesc: 'Para ejercer cualquiera de tus derechos GDPR, por favor contáctanos. Responderemos dentro de 30 días y podemos requerir verificación de identidad.',
    gdprSubmitRequest: 'Enviar Solicitud GDPR',
    gdprManageData: 'Gestionar Datos en el Perfil',
  },
  en: {
    features: 'Features',
    ...
    blogPost1Excerpt: 'Discover the latest design trends that will make your portfolio stand out from the competition and attract more opportunities.',
    ...
    blogPost2Excerpt: 'Learn how artificial intelligence is transforming the way professionals create, optimize, and manage their online portfolios.',
    blogPost2Author: 'Dr. Sarah Johnson',
    blogPost2ReadTime: '7 min read',
    blogPost3Title: 'From LinkedIn to Portfolio: Converting Connections to Clients',
    blogPost3Excerpt: 'Master the art of turning your LinkedIn network into a powerful client acquisition engine using your professional portfolio.',
    blogPost3Author: 'Marcus Rodriguez',
    ...
    careersApplyNow: 'Apply Now',
    careersKeyRequirements: 'Key Requirements:',
    careersNoMatchTitle: "Don't see a perfect match?",
    careersNoMatchDesc: "We're always looking for talented individuals who share our passion for innovation and excellence.",
    careersSendResume: 'Send Us Your Resume',
    ...
    careersPosition1Description: 'Join our engineering team to build the next generation of AI-powered portfolio tools. Work with React, Node.js, and cutting-edge AI technologies.',
    ...
    careersPosition2Description: 'Shape the user experience of PRISMA and help millions of professionals create stunning portfolios. Design for web and mobile platforms.',
    ...
    careersPosition3Description: 'Research and develop AI models for content generation, template recommendation, and portfolio optimization using latest ML techniques.',
    ...
    careersPosition4Description: 'Drive customer adoption and success, ensuring our users get maximum value from PRISMA. Work closely with product and engineering teams.',
    ...
    privacyInfoCollectText: 'We collect information you provide directly to us and data about how you use our services.',
    ...
    privacyHowUseText: 'We use the collected information to provide, maintain, and improve our services.',
    ...
    privacyDataProtectionText: 'We implement technical and organizational security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.',
    privacyYourRightsTitle: 'Your Rights',
    privacyYourRightsText: 'You have the right to access, update, delete, or export your personal information.',
    ...
    privacyCookiesTitle: 'Cookies',
    privacyCookiesText: 'We use cookies to improve your experience, analyze site traffic, and personalize content. You can control cookies through your browser settings.',
    privacyChangesTitle: 'Changes to this Policy',
    privacyChangesText: 'We may update this privacy policy from time to time. We will notify you of significant changes by posting the new policy on this page.',
    ...
    // Terms Page - Additional Missing Keys
    termsAcceptanceTitle: 'Acceptance of Terms',
    termsAcceptanceText: 'By accessing and using PRISMA, you agree to be bound by these Terms of Service and all applicable laws and regulations.',
    termsUseLicenseTitle: 'Use License',
    termsUseLicenseText: 'You are granted a limited, non-exclusive, non-transferable license to use PRISMA to create and manage your professional portfolio.',
    termsUseLicenseItem1: 'Create and publish your personal portfolio',
    termsUseLicenseItem2: 'Use AI tools to enhance your content',
    termsUseLicenseItem3: 'Share your portfolio with others',
    termsUseLicenseItem4: 'Access available templates and resources',
    termsAccountTitle: 'Your Account',
    termsAccountText: 'You are responsible for maintaining the confidentiality of your account and password. You accept responsibility for all activities that occur under your account.',
    termsContentTitle: 'Your Content',
    termsContentText: 'You retain all rights to the content you upload to PRISMA. By uploading content, you grant us a license to use it for the purpose of providing our services.',
    termsProhibitedTitle: 'Prohibited Uses',
    termsProhibitedText: 'You may not use PRISMA to:',
    termsProhibitedItem1: 'Violate laws or regulations',
    termsProhibitedItem2: 'Infringe intellectual property rights',
    termsProhibitedItem3: 'Distribute malware or harmful content',
    termsProhibitedItem4: 'Harass or harm other users',
    termsProhibitedItem5: 'Attempt unauthorized access to our systems',
    termsPaymentTitle: 'Payment and Billing',
    termsPaymentText: 'Paid plans are billed monthly or annually. Payments are non-refundable except where required by law.',
    termsTerminationTitle: 'Termination',
    termsTerminationText: 'We may terminate or suspend your account immediately, without prior notice, for any breach of these Terms.',
    termsDisclaimerTitle: 'Disclaimer',
    termsDisclaimerText: 'PRISMA is provided "as is" without warranties of any kind. We do not guarantee that the service will be uninterrupted or error-free.',
    termsChangesTitle: 'Changes to Terms',
    termsChangesText: 'We reserve the right to modify these terms at any time. Changes take effect immediately upon posting.',
    termsContactTitle: 'Contact Information',
    termsContactText: 'For questions about these Terms of Service, contact us at:',
    termsContactAddress: 'Mexico City, Mexico',

    // GDPR Page - Additional Missing Keys
    gdprWhatDataTitle: 'What Data We Collect',
    gdprAccountInfoTitle: 'Account Information',
    gdprAccountInfoDesc: 'Name, email address, password (encrypted), and profile information you provide.',
    gdprPortfolioDataTitle: 'Portfolio Data',
    gdprPortfolioDataDesc: 'Content you create, upload, or generate using our platform including text, images, and project information.',
    gdprUsageAnalyticsTitle: 'Usage Analytics',
    gdprUsageAnalyticsDesc: 'Aggregated, anonymized data about how you use our platform to improve our services.',
    gdprTechnicalDataTitle: 'Technical Data',
    gdprTechnicalDataDesc: 'IP address, browser type, device information, and cookies for security and functionality.',
    gdprLegalBasisTitle: 'Legal Basis for Processing',
    gdprContractTitle: 'Contract Performance',
    gdprContractDesc: 'Processing necessary to provide our portfolio creation services as outlined in our Terms of Service.',
    gdprLegitimateTitle: 'Legitimate Interest',
    gdprLegitimateDesc: 'Improving our services, security measures, and providing customer support.',
    gdprConsentTitle: 'Consent',
    gdprConsentDesc: 'Marketing communications, optional analytics, and third-party integrations you explicitly approve.',
    gdprExerciseTitle: 'Exercise Your Rights',
    gdprExerciseDesc: 'To exercise any of your GDPR rights, please contact us. We will respond within 30 days and may require identity verification.',
    gdprSubmitRequest: 'Submit GDPR Request',
