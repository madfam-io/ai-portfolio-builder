...
import { authService, type SignUpMetadata } from '@/lib/services/auth/auth-service';
    ...
    persist(
      subscribeWithSelector(
        ...
        signUp: async (email, password, metadata = {}) => {
          ...
          try {
            const { data, error } = await authService.signUp(email, password, metadata as SignUpMetadata);
