...
import { PortfolioPreview } from '@/components/editor';
...
import { FiArrowLeft, FiBookOpen, FiSettings, FiSave } from 'react-icons/fi';
import Link from 'next/link';

export default function InteractiveDemoPage() {
  const [currentStep, setCurrentStep] = useState<'template' | 'editor' | 'preview'>('template');
  const [selectedTemplate, setSelectedTemplate] = useState<TemplateType>('developer');
  const [isLoading, setIsLoading] = useState(false);
  
  // Initialize portfolio with sample data immediately
  const [portfolio, setPortfolio] = useState<Portfolio>(() => generateSamplePortfolio('developer'));
  ...
  const handleExport = () => {
    ...
    alert('In the full version, this would export your portfolio as PDF, HTML, or other formats.');
  };

  const handleShare = () => {
    // Demo share functionality
    alert('In the full version, this would generate a shareable link to your portfolio.');
  };
          ...
          <div className="max-w-6xl mx-auto px-6 py-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Start by selecting a template that matches your profession and style. 
                Each template is optimized for specific industries and career paths.
              </p>
            </div>
                  ...
                  <div className="grid gap-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handlePortfolioChange({
                              ...portfolio,
                              name: e.target.value
                            })}
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        You&apos;ve selected the <strong>{portfolio.template}</strong> template. 
            ...
            <div className="flex-1 bg-gray-100 dark:bg-gray-900 overflow-hidden">
              <div className="h-full flex items-center justify-center p-4">
                <div 
                  ...
                  style={{
                    width: previewDimensions.width === '100%' ? '100%' : previewDimensions.width,
                    height: previewDimensions.height === '100%' ? '100%' : previewDimensions.height,
