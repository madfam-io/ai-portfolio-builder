...
export function ResumeParser({
  ...
  const mockParsedData: ParsedResumeData = {
    personalInfo: {
      ...
      summary:
        'Experienced software engineer with 5+ years building scalable web applications and leading development teams.',
    },
    experience: [
      {
      ...
      },
      {
        ...
        duration: '2019 - 2020',
        description:
          'Developed client websites and web applications. Gained experience in full-stack development.',
        confidence: 88,
      },
    ],
    education: [
          ...
          <div className="mt-6 space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Intelligently identifies and extracts all sections of your
                  resume
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Confidence scores help you verify extracted information
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
