...
import { FiLinkedin, FiCheck, FiDownload, FiUser, FiBriefcase, FiAward } from 'react-icons/fi';
...
export function LinkedInImport({ onImport, isDemo = false, className = '' }: LinkedInImportProps) {
    ...
    experience: [
      {
        ...
        description: 'Lead development of microservices architecture serving 1M+ users. Reduced deployment time by 60% through CI/CD optimization.'
      },
      {
        company: 'StartupXYZ',
      ...
      },
      {
        ...
        duration: '2019 - 2020',
        description: 'Developed client websites and web applications. Gained experience in full-stack development and agile methodologies.'
      }
    ],
    skills: [
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Connect your LinkedIn profile to import your professional data</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="space-y-4 mb-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white">Professional Experience</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Import your work history, job titles, and descriptions</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <FiCheck className="w-5 h-5 text-green-500 mt-0.5" />
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white">Skills & Endorsements</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Get your skills with endorsement counts for credibility</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <FiCheck className="w-5 h-5 text-green-500 mt-0.5" />
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white">Education & Certifications</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Import your academic background and professional certifications</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-green-100">Ready to import your professional data</p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <h5 className="font-medium text-gray-900 dark:text-white">Profile</h5>
              </div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            <div className="flex items-center space-x-2 text-sm text-green-600 dark:text-green-400">
              ...
              <span>All data has been imported and is ready for customization</span>
            </div>
          </div>
        </div>
      )}
