      ...
      <div className="container mx-auto">
        ...
        <div className="border-t border-gray-300 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0 text-gray-600 dark:text-gray-300">
            © {getCurrentYear()} Portfolio Builder by MADFAM.{' '}
          ...
          <div className="flex justify-center md:justify-end space-x-6">
            <a
              ...
              aria-label="Follow Portfolio Builder on Twitter"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Follow Portfolio Builder on LinkedIn"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="View Portfolio Builder on GitHub"
            >
