      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {t.projectsDescription || 'Showcase your best work and accomplishments'}
          </p>
        </div>
        {!isAdding && !editingId && (
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">
              {editingId ? t.editProject || 'Edit Project' : t.addProject || 'Add Project'}
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <Label htmlFor="title">{t.projectTitle || 'Project Title'} *</Label>
              <Input
                id="title"
                value={formData.title}
                onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                placeholder={t.projectTitlePlaceholder || 'e.g. E-commerce Platform'}
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={t.projectDescriptionPlaceholder || 'Describe what the project does, your role, and the impact...'}
                rows={4}
              />
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div>
                <Label htmlFor="projectUrl">{t.projectUrl || 'Project URL'}</Label>
                <Input
                  id="projectUrl"
                  type="url"
                ...
                {formData.highlights?.map((highlight, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <Input
                      ...
                      placeholder={t.highlightPlaceholder || 'e.g. Increased performance by 50%'}
                    />
                    <Button
                      type="button"
                      variant="ghost"
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleSave}>
                {editingId ? t.saveChanges || 'Save Changes' : t.addProject || 'Add Project'}
              </Button>
            </div>
          </CardContent>
        </Card>
