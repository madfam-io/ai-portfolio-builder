...
describe('Edge Rate Limiter Middleware', () => {
  ...
  describe('Basic Rate Limiting', () => {
    it('should allow requests under the limit', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/test', { ip: '192.168.1.1' });
  ...
  describe('Route-Specific Limits', () => {
    it('should apply stricter limits to auth endpoints', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/auth/login', { ip: '192.168.1.1' });
      const result = await edgeRateLimiter(request);
    ...
    it('should apply higher limits to public endpoints', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/portfolios/public', { ip: '192.168.1.1' });
      const result = await edgeRateLimiter(request);
    ...
    it('should apply very strict limits to admin endpoints', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/admin/users', { ip: '192.168.1.1' });
      const result = await edgeRateLimiter(request);
    ...
    it('should bypass rate limiting for health checks', async () => {
      const request = createRequest('https://example.com/api/v1/health', { ip: '192.168.1.1' });
      const result = await edgeRateLimiter(request);
    ...
    it('should handle AI endpoint limits', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/ai/enhance', { ip: '192.168.1.1' });
      const result = await edgeRateLimiter(request);
  ...
  describe('Configuration', () => {
    it('should support custom rate limit configurations', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/custom', { ip: '192.168.1.1' });
  ...
  describe('Monitoring and Analytics', () => {
    ...
    it('should provide rate limiting statistics', async () => {
      ...
      const request = createRequest('https://example.com/api/v1/rate-limit-stats', { ip: '192.168.1.1' });
      const result = await edgeRateLimiter(request);
  ...
  describe('Security Features', () => {
    ...
    it('should handle distributed attacks', async () => {
      ...
      const results = await Promise.all(requests.map(req => edgeRateLimiter(req)));
