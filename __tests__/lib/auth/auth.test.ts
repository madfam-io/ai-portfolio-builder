...
describe('Authentication Service', () => {
  ...
  describe('signUp', () => {
    ...
    it('should require valid email format', async () => {
      ...
      // Act & Assert
      await expect(signUp(invalidEmail, password)).rejects.toThrow('Invalid email format')
    })
    ...
    it('should require minimum password length', async () => {
      ...
      // Act & Assert
      await expect(signUp(email, shortPassword)).rejects.toThrow('Password must be at least 8 characters')
    })
  })
