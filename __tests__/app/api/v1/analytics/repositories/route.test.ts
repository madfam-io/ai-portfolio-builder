...
// Mock required modules for repositories
...
describe('/api/analytics/repositories', () => {
  it('should handle GET request', async () => {
    try {
      // Import after mocks are set up
      const route = await import('@/app/api/analytics/repositories/route');
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => {
      ...
      require('@/app/api/analytics/repositories/route');
    }).not.toThrow();
  });
});