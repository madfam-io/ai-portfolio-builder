...
// Mock required modules for track
...
describe('/api/experiments/track', () => {
  it('should handle GET request', async () => {
    try {
      // Import after mocks are set up
      const route = await import('@/app/api/experiments/track/route');
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => {
      ...
      require('@/app/api/experiments/track/route');
    }).not.toThrow();
  });
});