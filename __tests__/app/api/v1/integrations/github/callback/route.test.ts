...
// Mock required modules for callback
...
describe('/api/integrations/github/callback', () => {
  it('should handle GET request', async () => {
    try {
      // Import after mocks are set up
      const route = await import('@/app/api/integrations/github/callback/route');
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => {
      ...
      require('@/app/api/integrations/github/callback/route');
    }).not.toThrow();
  });
});