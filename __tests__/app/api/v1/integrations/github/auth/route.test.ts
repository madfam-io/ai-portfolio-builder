...
// Mock required modules for auth
...
describe('/api/integrations/github/auth', () => {
  it('should handle GET request', async () => {
    try {
      // Import after mocks are set up
      const route = await import('@/app/api/integrations/github/auth/route');
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => {
      ...
      require('@/app/api/integrations/github/auth/route');
    }).not.toThrow();
  });
});