...
// Mock required modules for check-subdomain
...
describe('/api/portfolios/check-subdomain', () => {
  it('should handle GET request', async () => {
    try {
      // Import after mocks are set up
      const route = await import('@/app/api/portfolios/check-subdomain/route');
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => {
      ...
      require('@/app/api/portfolios/check-subdomain/route');
    }).not.toThrow();
  });
});