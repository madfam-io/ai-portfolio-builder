...
// Mock required modules for check-promotion
...
describe('/api/stripe/check-promotion', () => {
  it('should handle GET request', async () => {
    try {
      // Import after mocks are set up
      const route = await import('@/app/api/stripe/check-promotion/route');
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => {
      ...
      require('@/app/api/stripe/check-promotion/route');
    }).not.toThrow();
  });
});