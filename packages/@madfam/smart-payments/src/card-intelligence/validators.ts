...
export function validateCardNumber(cardNumber: string): ValidationResult {
  ...
  if (cleanNumber.length < lengthRange.min || cleanNumber.length > lengthRange.max) {
    errors.push({
      field: 'cardNumber',
      code: 'INVALID_LENGTH',
 ...
 * Validate CVV
 */
export function validateCVV(cvv: string, cardBrand?: CardBrand): ValidationResult {
  const errors: ValidationError[] = [];
...
export function detectCardBrand(cardNumber: string): CardBrand {
  ...
  // Elo (Brazilian)
  if (['401178', '401179', '438935', '457631', '457632', '431274', '451416', 
       '457393', '504175', '506699', '506770', '506771', '506772', '506773',
       '506774', '506775', '506776', '506777', '506778', '627780', '636297',
       '636368', '650031', '650032', '650033', '650035', '650036', '650037',
       '650038', '650039', '650040', '650041', '650042', '650043', '650044',
       '650045', '650046', '650047', '650048', '650049', '650050', '650051',
       '650052', '650053', '650054', '650055', '650056', '650057', '650058',
       '650059', '650060', '650061', '650062', '650063', '650064', '650065',
       '650066', '650067', '650068', '650069', '650070', '650071', '650072',
       '650073', '650074', '650075', '650076', '650077', '650078', '650079',
       '650080', '650081', '650082', '650083', '650084', '650085', '650086',
       '650087', '650088', '650089', '650090', '650091', '650092', '650093',
       '650094', '650095', '650096', '650097', '650098', '650099', '651652',
       '651653', '651654', '651655', '651656', '651657', '651658', '651659',
       '651660', '651661', '651662', '651663', '651664', '651665', '651666',
       '651667', '651668', '651669', '651670', '651671', '651672', '651673',
       '651674', '651675', '651676', '651677', '651678', '651679', '655000',
       '655001', '655002', '655003', '655004', '655005', '655006', '655007',
       '655008', '655009', '655010', '655011', '655012', '655013', '655014',
       '655015', '655016', '655017', '655018', '655019', '655020', '655021'].includes(firstSix)) {
    return 'elo';
  }
