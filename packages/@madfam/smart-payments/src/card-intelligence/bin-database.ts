...
const FALLBACK_BIN_RANGES: BINRange[] = [
  // Visa
  { start: '400000', end: '499999', brand: 'visa', type: 'credit', issuerName: 'Generic Visa', issuerCountry: 'US' },
  
  // Mastercard
  { start: '510000', end: '559999', brand: 'mastercard', type: 'credit', issuerName: 'Generic Mastercard', issuerCountry: 'US' },
  { start: '222100', end: '272099', brand: 'mastercard', type: 'credit', issuerName: 'Generic Mastercard', issuerCountry: 'US' },
  
  // American Express
  { start: '340000', end: '349999', brand: 'amex', type: 'credit', issuerName: 'American Express', issuerCountry: 'US' },
  { start: '370000', end: '379999', brand: 'amex', type: 'credit', issuerName: 'American Express', issuerCountry: 'US' },
  
  // Discover
  { start: '601100', end: '601199', brand: 'discover', type: 'credit', issuerName: 'Discover', issuerCountry: 'US' },
  { start: '644000', end: '659999', brand: 'discover', type: 'credit', issuerName: 'Discover', issuerCountry: 'US' },
  
  // Regional cards
  { start: '506700', end: '506899', brand: 'elo', type: 'credit', issuerName: 'Elo', issuerCountry: 'BR' },
  { start: '636297', end: '636297', brand: 'elo', type: 'credit', issuerName: 'Elo', issuerCountry: 'BR' },
  
  // Mexican banks (common BINs)
  { start: '421394', end: '421394', brand: 'visa', type: 'credit', issuerName: 'Banamex', issuerCountry: 'MX', issuerCurrency: 'MXN' },
  { start: '547074', end: '547074', brand: 'mastercard', type: 'credit', issuerName: 'Santander Mexico', issuerCountry: 'MX', issuerCurrency: 'MXN' },
  { start: '554620', end: '554629', brand: 'mastercard', type: 'debit', issuerName: 'BBVA Mexico', issuerCountry: 'MX', issuerCurrency: 'MXN' },
  
  // Brazilian banks
  { start: '548129', end: '548129', brand: 'mastercard', type: 'credit', issuerName: 'Banco do Brasil', issuerCountry: 'BR', issuerCurrency: 'BRL' },
  { start: '516259', end: '516259', brand: 'mastercard', type: 'credit', issuerName: 'Itaú', issuerCountry: 'BR', issuerCurrency: 'BRL' },
  
  // Indian banks
  { start: '461700', end: '461799', brand: 'visa', type: 'debit', issuerName: 'HDFC Bank', issuerCountry: 'IN', issuerCurrency: 'INR' },
  { start: '524338', end: '524338', brand: 'mastercard', type: 'credit', issuerName: 'ICICI Bank', issuerCountry: 'IN', issuerCurrency: 'INR' },
];
...
export class InMemoryBINDatabase implements BINDatabase {
  ...
  async lookup(bin: string): Promise<Partial<CardInfo>> {
    ...
    return {
      ...
      issuerCurrency: range.issuerCurrency || COUNTRY_CURRENCY_MAP[range.issuerCountry] || 'USD',
  ...
  isSupported(bin: string): boolean {
    const cleanBIN = bin.replace(/\D/g, '');
    return this.findRange(cleanBIN) !== null || this.detectBrandByPattern(cleanBIN) !== 'unknown';
  }
  ...
  private getCardFeatures(range: BINRange): CardInfo['features'] {
    ...
    const isLatam = ['MX', 'BR', 'AR', 'CL', 'CO', 'PE'].includes(range.issuerCountry);
    const isAsia = ['IN', 'SG', 'MY', 'TH', 'ID', 'PH', 'VN', 'KR', 'JP', 'CN'].includes(range.issuerCountry);
